...
const Footer = () => {
    return (
        <div className="bg-deepblue-800 w-full mt-12">
        <footer
            id="aksel-footer"
            data-theme="dark"
            className="flex pt-3 z-10 items-center w-6/6 sm:w-5/6 max-w-[80rem] m-auto justify-between toc-ignore text-text-on-inverted bg-deepblue-800 relative flex justify-center"
        >
            <div className="relative z-10 mx-auto grid w-full max-w-screen-2xl gap-12 px-4 pb-16 pt-12 md:grid-cols-2 md:px-6 lg:grid-cols-3 xl:grid-cols-4 xl:gap-3">
                <LogoBlock />
                <Snarveier />
{/*                <SideLenker />
                <Kontakt />*/}
    ...
    return (
        <div>
            ...
            <BodyShort as="ul" className="mt-3 grid gap-3">
                ...
                <FooterLink href="/tilgjengelighet">
                    Tilgjengelighet
                </FooterLink>
            </BodyShort>
        </div>
    ...
    return (
        <div>
            ...
            <BodyShort as="ul" className="mt-3 grid gap-3">
                ...
                <FooterLink href="https://github.com/navikt/reops-felgen#readme">
